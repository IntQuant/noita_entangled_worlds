...
util.copy_file_content("mods/quant.ew/files/system/spell_patches/spells_to_power.lua", "data/scripts/projectiles/spells_to_power.lua")
util.copy_file_content("mods/quant.ew/files/system/spell_patches/essence_to_power.lua", "data/scripts/projectiles/essence_to_power.lua")
