...
ModLuaFileAppend("data/scripts/items/heart.lua", "mods/quant.ew/files/src/system/heart_pickups/append/heart.lua")
ModLuaFileAppend("data/scripts/items/heart_better.lua", "mods/quant.ew/files/src/system/heart_pickups/append/heart_better.lua")
ModLuaFileAppend("data/scripts/items/heart_evil.lua", "mods/quant.ew/files/src/system/heart_pickups/append/heart_evil.lua")
ModLuaFileAppend("data/scripts/items/heart_fullhp.lua", "mods/quant.ew/files/src/system/heart_pickups/append/heart_fullhp.lua")
ModLuaFileAppend("data/scripts/items/heart_fullhp_temple.lua", "mods/quant.ew/files/src/system/heart_pickups/append/heart_fullhp_temple.lua")
