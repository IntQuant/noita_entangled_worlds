...
launcher_no_command_3 = Você pode colocar `noita_proxy --launch-cmd "%command%"` nas opções de inicialização da steam para intereceptar qualquer comando que steam use para iniciar o jogo.
