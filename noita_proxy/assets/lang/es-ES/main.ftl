...
launcher_no_command_3 = Puedes poner `noita_proxy --launch-cmd "%command%"` en los argumentos de inicio de Noita en Steam para interceptar  el comando que Steam usa para iniciar el juego.
