...
launcher_no_command_3 = Sie können `noita_proxy --launch-cmd "%command%"` in die Startoptionen von Steam einfügen, um den von Steam verwendeten Startbefehl abzufangen.
