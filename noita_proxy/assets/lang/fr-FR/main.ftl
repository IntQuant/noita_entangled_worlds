...
launcher_no_command_3 = Vous pouvez insérer `noita_proxy --launch-cmd "%command%"` dans les options de lancement Steam pour intercepter la commande qu'utilise Steam pour lancer le jeu.
