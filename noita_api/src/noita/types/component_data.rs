...
pub struct SpriteParticleEmitterComponent {
    ...
    pub randomize_rotation: ValueRange,
    pub randomize_angular_velocity: ValueRange,
    pub randomize_alpha: ValueRange,
    pub randomize_animation_speed_coeff: ValueRange,
...
pub struct ParticleEmitterComponent {
    ...
    pub area_circle_radius: ValueRange,
