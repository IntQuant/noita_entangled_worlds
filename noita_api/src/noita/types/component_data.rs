...
pub struct CharacterPlatformingComponent {
    ...
    pub velocity_max_y: LensValue<f32>,
    pub run_velocity: LensValue<f32>,
    pub fly_velocity_x: LensValue<f32>,
    pub jump_velocity_x: f32,
    pub jump_velocity_y: f32,
    pub jump_keydown_buffer: isize,
    pub fly_speed_max_up: LensValue<f32>,
    pub fly_speed_max_down: LensValue<f32>,
    ...
    pub animation_to_play: StdString,
    pub animation_to_play_next: StdString,
    ...
    pub audio_liquid_splash_intensity: f32,
    pub m_ex_animation_pos: Vec2,
...
pub struct ItemPickUpperComponent {
    ...
    field8_0x52: u8,
    field9_0x53: u8,
    pub m_latest_item_overlap_info_box_position: Vec2,
    field11_0x5c: u8,
    field12_0x5d: u8,
    field13_0x5e: u8,
    field14_0x5f: u8,
...
pub struct AudioLoopComponent {
    ...
    pub m_volume: f32,
    pub m_intensity: f32,
    pub m_intensity2: f32,
    pub m_source: AudioSourceHandle,
...
pub struct GenomeDataComponent {
    ...
    pub friend_thundermage: LensValue<bool>,
    pub friend_firemage: LensValue<bool>,
...
pub struct HotspotComponent {
    ...
    field4_0x52: u8,
    field5_0x53: u8,
    pub sprite_hotspot_name: StdString,
    field7_0x6c: u8,
    field8_0x6d: u8,
    field9_0x6e: u8,
    field10_0x6f: u8,
...
pub struct GameLogComponent {
    ...
    field4_0x4b: u8,
    pub m_new_biome_check_frame: isize,
    pub m_visitied_biomes: VecVisited,
    field7_0x5c: u8,
    field8_0x5d: u8,
    field9_0x5e: u8,
    field10_0x5f: u8,
...
pub struct CharacterDataComponent {
    ...
    pub collision_aabb_min_y: LensValue<f32>,
    pub collision_aabb_max_y: LensValue<f32>,
    field6_0x7c: u8,
    field7_0x7d: u8,
    field8_0x7e: u8,
    field9_0x7f: u8,
    ...
    pub gravity: f32,
    pub fly_time_max: LensValue<f32>,
    ...
    pub dont_update_velocity_and_transform: bool,
    field53_0xfe: u8,
    field54_0xff: u8,
...
pub struct GhostComponent {
    ...
    pub target_tag: StdString,
    pub m_target_position: Vec2,
    pub m_target_entity_id: isize,
    pub m_random_target: Vec2,
...
pub struct VerletPhysicsComponent {
    ...
    pub animation_target_offset: Vec2,
    ...
    pub m_position_previous: Vec2,
    pub m_is_culled_previous: bool,
    field34_0xad: u8,
    field35_0xae: u8,
    field36_0xaf: u8,
    pub masses: FloatArrayInline,
    pub positions: Vec2ArrayInline,
    pub positions_prev: Vec2ArrayInline,
    pub velocities: Vec2ArrayInline,
    pub dampenings: FloatArrayInline,
    pub freedoms: FloatArrayInline,
    pub links: VerletLinkArrayInline,
    pub colors: UisizeArrayInline,
    pub materials: UisizeArrayInline,
    pub sprite: *mut VerletSprite,
    field47_0x2b34: u8,
    field48_0x2b35: u8,
    field49_0x2b36: u8,
    field50_0x2b37: u8,
...
pub struct SpriteParticleEmitterComponent {
    ...
    pub z_index: f32,
    pub randomize_lifetime: ValueRange<f32>,
    pub randomize_position: AABB,
    pub randomize_position_inside_hitbox: bool,
    field30_0xe9: u8,
    field31_0xea: u8,
    field32_0xeb: u8,
    pub randomize_velocity: AABB,
    pub randomize_scale: AABB,
    pub randomize_rotation: ValueRange<f32>,
    pub randomize_angular_velocity: ValueRange<f32>,
    pub randomize_alpha: ValueRange<f32>,
    pub randomize_animation_speed_coeff: ValueRange<f32>,
    pub velocity_always_away_from_center: bool,
    field40_0x12d: u8,
    field41_0x12e: u8,
    field42_0x12f: u8,
    pub expand_randomize_position: Vec2,
    ...
    pub count_min: isize,
    pub count_max: isize,
    pub emission_interval_min_frames: isize,
    pub emission_interval_max_frames: isize,
...
pub struct PhysicsAIComponent {
    ...
    pub m_last_position_when_had_path: Vec2,
...
pub struct AltarComponent {
    ...
    pub m_recognized_entity_tags: EntityTags,
...
pub struct GameStatsComponent {
    ...
    field23_0x5e: u8,
    field24_0x5f: u8,
    pub stats_filename: StdString,
    pub is_player: bool,
    field27_0x79: u8,
    field28_0x7a: u8,
    field29_0x7b: u8,
    pub extra_death_msg: StdString,
...
pub struct InheritTransformComponent {
    ...
    field3_0x4a: u8,
    field4_0x4b: u8,
    pub parent_hotspot_tag: StdString,
...
pub struct ParticleEmitterComponent {
    ...
    pub area_circle_radius: ValueRange<f32>,
    ...
    pub count_min: LensValue<isize>,
    pub count_max: LensValue<isize>,
    pub emission_interval_min_frames: isize,
    pub emission_interval_max_frames: isize,
    pub emission_chance: isize,
    pub custom_style: ParticleEmitterCustomStyle,
    ...
    field61_0x11a: u8,
    field62_0x11b: u8,
    pub image_animation_file: StdString,
    pub image_animation_colors_file: StdString,
    ...
    pub m_material_id: LensValue<isize>,
    pub m_next_emit_frame: isize,
    pub m_has_emitted: bool,
    field81_0x17d: u8,
    field82_0x17e: u8,
    field83_0x17f: u8,
    pub m_last_emit_position: Vec2i,
    pub m_cached_image_animation: *mut ParticleEmitterAnimation,
...
pub struct CellEaterComponent {
    ...
    pub only_stain: bool,
    pub eat_dynamic_physics_bodies: bool,
    pub limited_materials: bool,
    field7_0x57: u8,
    pub ignored_material_tag: StdString,
    pub materials: VecMaterials,
    field10_0x7c: u8,
    field11_0x7d: u8,
    field12_0x7e: u8,
    field13_0x7f: u8,
...
pub struct InventoryComponent {
    ...
    pub ui_position_on_screen: Vec2i,
    pub ui_element_sprite: StdString,
    pub actions: StdString,
    pub update_listener: *mut InvenentoryUpdateListener,
    pub items: VecInventoryItem,
    field9_0xa4: u8,
    field10_0xa5: u8,
    field11_0xa6: u8,
    field12_0xa7: u8,
...
pub struct PlayerCollisionComponent {
    ...
    pub debug_stuck_in_static_ground: isize,
    pub m_collided_horizontally: bool,
    field7_0x5d: u8,
    field8_0x5e: u8,
    field9_0x5f: u8,
    pub m_physics_collision_hax: *mut B2Body,
    field11_0x64: u8,
    field12_0x65: u8,
    field13_0x66: u8,
    field14_0x67: u8,
...
pub struct IKLimbComponent {
    ...
    pub m_joint_side_interpolation: f32,
    pub m_joint_world_pos: Vec2,
    pub m_part0_prev_pos: Vec2,
    pub m_part0_prev_rotation: f32,
    pub m_part1_prev_pos: Vec2,
    pub m_part1_prev_rotation: f32,
    pub m_end_prev_pos: Vec2,
    field11_0x84: u8,
    field12_0x85: u8,
    field13_0x86: u8,
    field14_0x87: u8,
...
pub struct KickComponent {
    ...
    field3_0x4a: u8,
    field4_0x4b: u8,
    pub max_force: LensValue<f32>,
    pub player_kickforce: LensValue<f32>,
    pub kick_radius: f32,
    pub kick_damage: LensValue<f32>,
    pub kick_knockback: LensValue<f32>,
    pub telekinesis_throw_speed: f32,
    pub kick_entities: StdString,
    field12_0x9c: u8,
    field13_0x9d: u8,
    field14_0x9e: u8,
    field15_0x9f: u8,
...
pub struct MaterialSuckerComponent {
    ...
    field12_0x5f: u8,
    pub suck_tag: StdString,
    pub randomized_position: IAABB,
...
pub struct LuaComponent {
    ...
    pub m_persistent_values: MapValue,
    field49_0x2dc: u8,
    field50_0x2dd: u8,
    field51_0x2de: u8,
    field52_0x2df: u8,
...
pub struct StatusEffectDataComponent {
    ...
    pub ingestion_effects: VecFloat,
    pub ingestion_effect_causes: VecMaterials,
    pub ingestion_effect_causes_many: VectorInt32,
    pub m_last_attacking_player_frame: isize,
    pub m_stain_effects_smoothed_for_ui: VecFloat,
...
pub struct ElectricityReceiverComponent {
    ...
    pub switch_on_msg_interval_frames: isize,
    pub electrified_msg_interval_frames: isize,
...
pub struct CrawlerAnimalComponent {
    ...
    field34_0x96: u8,
    field35_0x97: u8,
    pub m_prev_non_snapped_position: Vec2,
    pub m_prev_cell_position: Vec2i,
    pub m_prev_cell_position2: Vec2i,
    pub m_prev_cell_position3: Vec2i,
    pub m_prev_cell_position4: Vec2i,
    pub m_prev_cell_position5: Vec2i,
    pub m_prev_cell_position6: Vec2i,
    pub m_prev_cell_position7: Vec2i,
    pub m_prev_cell_position8: Vec2i,
    pub m_latest_position: Vec2i,
...
pub struct IngestionComponent {
    ...
    pub ingestion_satiation_material_tag: StdString,
    pub m_ingestion_cooldown_frames: isize,
    pub m_next_overeating_msg_frame: isize,
    pub m_ingestion_satiation_material_tag_cached: StdString,
    pub m_ingestion_satiation_material_cache: StdSetIsize32,
...
pub struct AttachToEntityComponent {
    ...
    field4_0x4e: u8,
    field5_0x4f: u8,
    pub target_hotspot_tag: StdString,
...
impl Component for PhysicsJoint2Component {
    fn default(base: ComponentData) -> Self {
        Self {
            base,
            ..Default::default()
...
#[derive(Debug, Default)]
#[repr(C)]
pub struct PhysicsJoint2Component {
    pub base: ComponentData,
    pub joint_id: u16,
    field2_0x4a: u8,
    field3_0x4b: u8,
...
pub struct DamageModelComponent {
    ...
    pub ragdoll_fx_forced: RagdollFx,
    ...
    pub m_damage_materials: StdVecInt,
    pub m_damage_materials_how_much: StdVecFloat,
    pub m_collision_message_materials: StdVecInt,
    pub m_collision_message_material_counts_this_frame: StdVecInt,
    pub m_material_damage_this_frame: StdVecFloat,
    ...
    pub m_physics_damage_entity: EntityTypeID,
    pub m_physics_damage_telekinesis_caster_entity: EntityTypeID,
...
pub struct ShotEffectComponent {
    ...
    field3_0x4a: u8,
    field4_0x4b: u8,
    pub condition_status: StatusEffectType,
...
pub struct ProjectileComponent {
    ...
    field6_0x56: u8,
    field7_0x57: u8,
    pub config: ConfigGunActionInfo,
    pub speed_min: f32,
    pub speed_max: f32,
    pub friction: f32,
    ...
    pub shoot_light_flash_r: usize,
    pub shoot_light_flash_g: usize,
    pub shoot_light_flash_b: usize,
    pub create_shell_casing: bool,
    field22_0x2c5: u8,
    field23_0x2c6: u8,
    field24_0x2c7: u8,
    pub shell_casing_material: StdString,
    pub shell_casing_offset: Vec2,
    pub muzzle_flash_file: StdString,
    ...
    pub go_through_this_material: StdString,
    ...
    pub on_death_emit_particle_type: StdString,
    ...
    pub ragdoll_fx_on_collision: RagdollFx,
    pub collide_with_entities: bool,
    field94_0x541: u8,
    field95_0x542: u8,
    field96_0x543: u8,
    pub collide_with_tag: StdString,
    pub dont_collide_with_tag: StdString,
    ...
    field103_0x57b: u8,
    pub damage: f32,
    pub damage_by_type: ConfigDamagesByType,
...
pub struct PlatformShooterPlayerComponent {
    ...
    pub eating_area_min: Vec2i,
    pub eating_area_max: Vec2i,
    ...
    field14_0x7e: u8,
    field15_0x7f: u8,
    pub m_smoothed_camera_position: Vec2,
    pub m_smoothed_aiming_vector: Vec2,
    ...
    pub m_cam_correction_gain_smoothed: Vec2,
    pub m_camera_error_prev: Vec2ArrayInline,
    pub m_cam_error_averaged: Vec2,
...
pub struct ItemComponent {
    ...
    pub preferred_inventory: InventoryKind,
...
pub struct AnimalAIComponent {
    ...
    field50_0xde: u8,
    field51_0xdf: u8,
    pub attack_melee_finish_config_explosion: ConfigExplosion,
    ...
    pub attack_ranged_frames_between: LensValue<isize>,
    ...
    field67_0x28e: u8,
    field68_0x28f: u8,
    pub attack_ranged_entity_file: StdString,
    ...
    pub m_ai_state_stack: AIStateStack,
    ...
    pub m_frame_next_give_up: isize,
    pub m_last_frames_movement_area_min: Vec2,
    pub m_last_frames_movement_area_max: Vec2,
    pub m_food_material_id: isize,
    pub m_food_particle_effect_material_id: isize,
    pub m_aggression: LensValue<f32>,
    pub m_next_jump_lob: f32,
    pub m_next_jump_target: Vec2,
...
pub struct GameEffectComponent {
    ...
    pub causing_status_effect: StatusEffectType,
...
pub struct MoveToSurfaceOnCreateComponent {
    ...
    pub ray_count: isize,
    pub verlet_min_joint_distance: f32,
    field9_0x5c: u8,
    field10_0x5d: u8,
    field11_0x5e: u8,
    field12_0x5f: u8,
...
pub struct PathFindingComponent {
    ...
    pub iterations_max_with_goal: isize,
    pub cost_of_flying: f32,
    pub distance_to_reach_node_x: isize,
    pub distance_to_reach_node_y: isize,
    pub frames_to_get_stuck: isize,
    pub frames_between_searches: isize,
    pub y_walking_compensation: f32,
    pub can_fly: bool,
    pub can_walk: bool,
    pub can_jump: bool,
    pub can_dive: bool,
    pub can_swim_on_surface: bool,
    pub never_consider_line_of_sight: bool,
    field17_0x76: u8,
    field18_0x77: u8,
    pub space_required: f32,
    pub max_jump_distance_from_camera: f32,
    pub jump_speed: f32,
    pub initial_jump_lob: f32,
    pub initial_jump_max_distance_x: f32,
    pub initial_jump_max_distance_y: f32,
    pub jump_trajectories: VectorJumpParams,
    pub read_state: isize,
    pub input: PathFindingInput,
    pub job_result_receiver: MsgQueuePathFindingResult,
    pub waiting_for: bool,
    field30_0x145: u8,
    field31_0x146: u8,
    field32_0x147: u8,
    pub next_search_frame: isize,
    field34_0x14c: u8,
    field35_0x14d: u8,
    field36_0x14e: u8,
    field37_0x14f: u8,
    ...
    field44_0x156: u8,
    field45_0x157: u8,
    pub path_next_node: PathFindingResultNode,
    pub path_next_node_vector_to: Vec2,
    pub path_next_node_distance_to: f32,
    pub path_previous_node: PathFindingNodeHandle,
    pub path_frames_stuck: isize,
    pub path_is_stuck: bool,
    field52_0x185: u8,
    field53_0x186: u8,
    field54_0x187: u8,
    pub path_last_frame_with_job: isize,
    pub m_logic: *mut PathFindingLogic,
    pub m_fallback_logic: *mut PathFindingLogic,
    pub m_selected_logic: *mut PathFindingLogic,
    pub m_enabled: bool,
    field60_0x199: u8,
    field61_0x19a: u8,
    field62_0x19b: u8,
    pub m_state: PathFindingComponentState,
    pub m_times_stuck: isize,
    pub m_next_clear_dont_approach_list_frame: isize,
    pub m_node_proximity_check_correction_y: f32,
    pub debug_path: VectorPathnode,
    pub jump_velocity_multiplier: LensValue<f32>,
    field69_0x1c4: u8,
    field70_0x1c5: u8,
    field71_0x1c6: u8,
    field72_0x1c7: u8,
...
pub struct PhysicsPickUpComponent {
    pub base: ComponentData,
    pub transform: Transform,
    pub original_left_joint_pos: Vec2,
    pub original_right_joint_pos: Vec2,
    pub pick_up_strength: f32,
    pub is_broken: bool,
    field6_0x7d: u8,
    field7_0x7e: u8,
    field8_0x7f: u8,
    pub left_joint_pos: Vec2,
    pub right_joint_pos: Vec2,
    pub left_joint: *mut B2WeldIsize,
    pub right_joint: *mut B2WeldIsize,
}
...
pub struct ElectricChargeComponent {
    ...
    pub fx_emission_interval_min: isize,
    pub fx_emission_interval_max: isize,
    pub charge: isize,
}
...
pub struct IKLimbAttackerComponent {
    ...
    field6_0x56: u8,
    field7_0x57: u8,
    pub target_entities_with_tag: StdString,
    pub m_target: Vec2,
    pub m_target_entity: isize,
    pub m_state: IKLimbAttackerState,
...
pub struct SetStartVelocityComponent {
    pub base: ComponentData,
    pub velocity: Vec2,
    pub randomize_angle: ValueRange<f32>,
    pub randomize_speed: ValueRange<f32>,
}
...
pub struct IKLimbsAnimatorComponent {
    ...
    field13_0x66: u8,
    field14_0x67: u8,
    pub m_prev_body_position: Vec2,
    pub m_limb_states: IKLimbStateVec,
...
pub struct WormComponent {
    ...
    pub ragdoll_filename: StdString,
    pub is_water_worm: bool,
    field17_0xa1: u8,
    field18_0xa2: u8,
    field19_0xa3: u8,
    pub max_speed: f32,
    pub m_target_vec: Vec2,
    ...
    pub m_prev_positions: WormPartPositions,
    field34_0x174: u8,
    field35_0x175: u8,
    field36_0x176: u8,
    field37_0x177: u8,
...
pub struct IKLimbWalkerComponent {
    ...
    pub ray_skip_material: isize,
    pub m_target: Vec2,
    pub m_prev_target: Vec2,
    pub m_prev_center_position: Vec2,
    pub m_state: isize,
}
...
pub struct SpriteAnimatorComponent {
    ...
    field4_0x62: u8,
    field5_0x63: u8,
    pub m_states: StackAnimationState,
    pub m_cached_target_sprite_tag: ComponentTags,
...
pub struct ItemChestComponent {
    ...
    field7_0x57: u8,
    pub actions: StdString,
    pub action_uses_remaining: StdString,
    pub other_entities_to_spawn: StdString,
    pub m_seed: usize,
    field12_0xa4: u8,
    field13_0xa5: u8,
    field14_0xa6: u8,
...
pub struct DamageNearbyEntitiesComponent {
    ...
    pub damage_description: StdString,
    pub target_tag: StdString,
    pub ragdoll_fx: RagdollFx,
    pub m_velocity: Vec2,
...
pub struct PhysicsRagdollComponent {
    ...
    pub offset_x: f32,
    pub offset_y: f32,
    pub bodies: VecPtrB2Body,
    field6_0x84: u8,
    field7_0x85: u8,
    field8_0x86: u8,
    field9_0x87: u8,
}
impl Component for VerletWorldJointComponent {
    fn default(base: ComponentData) -> Self {
        Self {
            base,
            ..Default::default()
...
#[derive(Debug, Default)]
#[repr(C)]
pub struct VerletWorldJointComponent {
    pub base: ComponentData,
...
pub struct GameAreaEffectComponent {
    ...
    pub game_effect_entitities: VecStr,
    pub m_entities_applied_out_to: VecInt,
    pub m_entities_applied_frame: VectorInt,
    field7_0x8c: u8,
    field8_0x8d: u8,
    field9_0x8e: u8,
    field10_0x8f: u8,
...
pub struct SpriteStainsComponent {
    ...
    field4_0x4e: u8,
    field5_0x4f: u8,
    pub stain_shaken_drop_chance_multiplier: LensValue<isize>,
    pub m_data: *mut SpriteStains,
    pub m_texture_handle: VirtualTextureHandle,
...
pub struct MagicConvertMaterialComponent {
    ...
    pub from_material_tag: StdString,
    ...
    field29_0x96: u8,
    field30_0x97: u8,
    pub from_material_array: StdString,
    pub to_material_array: StdString,
    pub m_use_arrays: bool,
    field34_0xc9: u8,
    field35_0xca: u8,
    field36_0xcb: u8,
    pub m_from_material_array: StdVecInt,
    pub m_to_material_array: StdVecInt,
    pub m_radius: isize,
}
...
pub struct ControlsComponent {
    ...
    pub m_aiming_vector: Vec2,
    pub m_aiming_vector_normalized: Vec2,
    pub m_aiming_vector_non_zero_latest: Vec2,
    pub m_gamepad_aiming_vector_raw: Vec2,
    pub m_jump_velocity: Vec2,
    pub m_mouse_position: Vec2,
    pub m_mouse_position_raw: Vec2,
    pub m_mouse_position_raw_prev: Vec2,
    pub m_mouse_delta: Vec2,
    pub m_gamepad_indirect_aiming: Vec2,
    pub m_game_pad_cursor_in_world: Vec2,
    ...
    pub input_latency_frames: LensValue<isize>,
    pub enabled: bool,
...
pub struct WorldStateComponent {
    ...
    pub lua_globals: MapStringString,
    pub pending_portals: VecPendingPortal,
    pub next_portal_id: usize,
    pub apparitions_per_level: VectorInt32,
    pub npc_parties: VecNpcParty,
    pub session_stat_file: StdString,
    pub orbs_found_thisrun: VectorInt32,
    pub flags: VectorString,
    pub changed_materials: VectorString,
    pub player_polymorph_count: isize,
    ...
    pub cuts_through_world: VecCutThroughWorld,
...
pub struct AudioComponent {
    ...
    field23_0x5e: u8,
    field24_0x5f: u8,
    pub event_root: StdString,
    pub audio_physics_material: StdString,
    ...
    pub m_latest_source: AudioSourceHandle,
    field33_0x9c: u8,
    field34_0x9d: u8,
    field35_0x9e: u8,
    field36_0x9f: u8,
...
pub struct TeleportComponent {
    ...
    field4_0x52: u8,
    field5_0x53: u8,
    pub source_particle_fx_file: StdString,
    pub target_particle_fx_file: StdString,
    pub load_collapse_entity: bool,
    field9_0x85: u8,
    field10_0x86: u8,
    field11_0x87: u8,
    pub safety_counter: isize,
    pub state: TeleportComponentState,
    pub teleported_entities: VecInt,
    pub source_location_camera_aabb: AABB,
    field16_0xac: u8,
    field17_0xad: u8,
    field18_0xae: u8,
    field19_0xaf: u8,
...
impl Component for PhysicsJointComponent {
    fn default(base: ComponentData) -> Self {
        Self {
            base,
            ..Default::default()
...
impl Component for PhysicsJoint2MutatorComponent {
    fn default(base: ComponentData) -> Self {
        Self {
            base,
            ..Default::default()
...
#[derive(Debug, Default)]
#[repr(C)]
pub struct PhysicsJoint2MutatorComponent {
    pub base: ComponentData,
    pub joint_id: u16,
    pub destroy: bool,
    field3_0x4b: u8,
...
pub struct AreaDamageComponent {
    ...
    pub death_cause: StdString,
    pub entities_with_tag: StdString,
    field10_0x9c: u8,
    field11_0x9d: u8,
    field12_0x9e: u8,
    field13_0x9f: u8,
...
pub struct SpriteComponent {
    ...
    pub offset_animator_offset: Vec2,
    pub alpha: f32,
    pub visible: bool,
    pub emissive: bool,
    pub additive: bool,
    ...
    field17_0x86: u8,
    field18_0x87: u8,
    pub rect_animation: StdString,
    pub next_rect_animation: StdString,
    field21_0xb8: u8,
    field22_0xb9: u8,
    field23_0xba: u8,
    field24_0xbb: u8,
    ...
    field55_0xe3: u8,
    pub m_sprite: *const Sprite,
    pub m_render_list: *mut SpriteRenderList,
...
pub struct MaterialInventoryComponent {
    ...
    pub count_per_material_type: VecDouble,
...
pub struct BossDragonComponent {
    ...
    pub jump_cam_shake_distance: f32,
    pub eat_anim_wait_mult: f32,
    pub projectile_1: StdString,
    pub projectile_1_count: isize,
    pub projectile_2: StdString,
    ...
    pub m_speed: f32,
    pub m_random_target: Vec2,
    pub m_last_living_target_pos: Vec2,
    pub m_next_target_check_frame: isize,
    pub m_next_hunt_target_check_frame: isize,
    pub m_on_ground_prev: bool,
    field40_0x11d: u8,
